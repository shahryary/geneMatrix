...
'''
Make regions between for each records
original file is :/mnt/intStorage/maize_scATAC_atlas/startS1_endE1.bed

  
'''
def find_scope(bed_file, output):
    extracted_region = []
    # reading bed file
